/**
 * Base Components — kitchen sink showcasing every primitive driven by
 * --theme-* custom properties.  Plain pict-view with one template.
 */
const libPictView = require('pict-view');

const VIEW_ID = 'Playground-BaseComponents';
const TARGET_ID = 'Playground-BaseComponents-Destination';

class PictViewPlaygroundBase extends libPictView
{
...
module.exports = {
	...
	ViewClass: PictViewPlaygroundBase,
	DestinationId: TARGET_ID,
	ViewConfiguration:
	{
		ViewIdentifier: VIEW_ID,
		DefaultRenderable: 'Playground-BaseComponents-Content',
		DefaultDestinationAddress: '#' + TARGET_ID,
		AutoRender: false,
		Templates:
		[
			{
				Hash: 'Playground-BaseComponents-Content',
				Template: /*html*/`
...
<div class="gallery">
	...
	<div class="gallery-card">
		...
		[
			{
				RenderableHash: 'Playground-BaseComponents-Content',
				TemplateHash: 'Playground-BaseComponents-Content',
